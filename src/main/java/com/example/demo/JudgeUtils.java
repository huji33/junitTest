...
public class JudgeUtils extends MiraiPrjApplication {
	...
	// 定数
	public static final int PLAY_AGE = 17; //プレイ対象年齢
	public static final int BILLING_AGE = 18;  //課金対象年齢
	...
	public boolean isBillingAge(Date birthDay) {
		...
		// 年からプレイ可能年齢を引く
		compareCal.add(Calendar.YEAR, -BILLING_AGE);
	...
	public boolean isRegisterdAge(Date birthDay) {
		...
		compareCal.set(curYear, curMonth, curDate);
		// 年からプレイ可能年齢を引く
		compareCal.add(Calendar.YEAR, -PLAY_AGE);
